import{_ as k,b}from"./LayoutDefault.vue_vue_type_script_setup_true_lang.5b3e43c9.js";import{d as w,u as C,a6 as S,U as u,D as B,G as R,B as c,H as $,m as A,o as i,c as d,w as D,ap as L,aq as q,f as e,g as M,e as s,$ as N,s as P,b as U,t as o,i as g,ac as V,j as z}from"./index.1ac7968d.js";import{s as E}from"./setSiteTitle.db0fa839.js";import"./Logo.vue_vue_type_script_setup_true_lang.d24c6e39.js";import"./PvSelect.vue_vue_type_script_setup_true_lang.b9a5aafc.js";import"./use-controllable.47bc6abe.js";/*! PatchyVideo/Platinum by VoileLabs */const H={key:0,class:"max-w-screen-xl mx-auto"},j=s("div",{class:"w-full aspect-ratio-6/1 bg-gray-200 dark:bg-gray-600"},null,-1),G={class:"flex flex-row lt-sm:mt-2 ml-4 md:ml-16"},I={class:"aspect-ratio-1/1 flex-shrink-0 flex-grow-0 sm:-mt-16"},Q={class:"mt-1 sm:mt-2 ml-2 sm:ml-6"},T=["textContent"],F={class:"text-xs sm:text-sm text-gray-800 dark:text-gray-300"},J=["textContent"],K={class:"mt-4 ml-8"},se=w({__name:"Profile",setup(O){const{t:n}=C(),f=V(),p=S(),m=u(()=>f.params.uid),_=u(()=>m.value===p.uid),{result:x,loading:v}=B(R`
    query ($uid: String!) {
...
//# sourceMappingURL=Profile.3cc93fa4.js.map
