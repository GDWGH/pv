import{_ as T,b as U,c as z}from"./LayoutDefault.vue_vue_type_script_setup_true_lang.f771bd62.js";import{d as D,u as F,U as v,D as y,G as w,B as k,H as $,m as C,o as l,c as _,w as u,ap as P,aq as W,f as a,g as i,e as t,$ as E,s as M,b as d,t as n,Q as m,F as f,h as S,i as p,ac as Q,j,P as G,ax as J}from"./index.20d30437.js";import{s as K}from"./setSiteTitle.db0fa839.js";import{_ as O}from"./Cover.vue_vue_type_script_setup_true_lang.37050cca.js";import{_ as X}from"./PvTabs.vue_vue_type_script_setup_true_lang.4b39eea6.js";import"./Logo.vue_vue_type_script_setup_true_lang.7f7c8259.js";import"./PvSelect.vue_vue_type_script_setup_true_lang.01ccfe72.js";import"./use-controllable.01c3d175.js";import"./index.3d7cc9fe.js";/*! PatchyVideo/Platinum by VoileLabs */const Y={key:0,class:"max-w-screen-xl mx-auto"},Z=t("div",{class:"w-full aspect-ratio-6/1 bg-gray-200 dark:bg-gray-600"},null,-1),ee={class:"flex flex-row lt-sm:mt-2 ml-4 md:ml-16"},te={class:"aspect-ratio-1/1 flex-shrink-0 flex-grow-0 sm:-mt-16"},ae={class:"mt-1 sm:mt-2 ml-2 sm:ml-6"},se=["textContent"],re={class:"text-md sm:text-base text-gray-800 dark:text-gray-300"},oe={class:"inline-flex align-middle flex-row space-x-1 flex-nowrap"},le=["href"],ie=["textContent"],ne={class:"mt-4 ml-8"},ue={key:0},de={class:"flex flex-nowrap gap-2"},me=t("span",{class:"i-uil:external-link-alt text-lg"},null,-1),ce={class:"grid mt-2 grid-cols-5 grid-flow-row gap-x-2"},ge=["textContent"],_e={class:"w-full text-xs truncate text-gray-600 dark:text-gray-300 font-light"},Ce=D({__name:"Author",setup(fe){const{t:h}=F(),V=Q(),q=v(()=>Number(V.params.tid)),{result:R,loading:A}=y(w`
    query ($tid: Int!) {
...
//# sourceMappingURL=Author.c3a777a2.js.map
