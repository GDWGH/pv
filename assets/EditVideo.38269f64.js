import{d as B,u as q,a6 as E,U as m,D as N,G as h,B as r,H as T,m as p,a7 as w,q as A,f as i,o as f,g as x,e as l,t as d,c as D,i as F,ap as H,aq as I,aE as M,ac as P}from"./index.d563c4c8.js";import{_ as R}from"./PvSelect.vue_vue_type_script_setup_true_lang.3f2c3310.js";import{s as n}from"./setSiteTitle.db0fa839.js";import"./use-controllable.26794bb9.js";/*! PatchyVideo/Platinum by VoileLabs */const U={key:0,class:"mx-2"},G={class:"pl-2 text-gray-700 dark:text-gray-200 border-b border-purple-200 dark:border-gray-700"},Q={class:"mx-2 mt-1"},j={class:"flex flex-col gap-2"},z={class:"flex"},J=["textContent"],K={class:"flex"},L=["textContent"],te=B({__name:"EditVideo",setup(O){const{t}=q(),y=P(),C=E(),_=m(()=>y.params.vid),{result:V,loading:S,refetch:$}=N(h`
    query ($vid: String!) {
...
//# sourceMappingURL=EditVideo.38269f64.js.map
